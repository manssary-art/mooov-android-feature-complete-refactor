...
class _OrderPlacementScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final productConditionNotifier = ref.watch(productConditionProvider.notifier);
    ...
    final numOfWorkersRequestedNotifier = ref.watch(numOfWorkersRequestedProvider.notifier);
          ...
          OrderPlacementStep.imagesGiveAway => HookConsumer(
              builder: (context, ref, child) {
                ...
                return OrderPlacementStepImagesGiveAwayContent(
                  ...
                  onAddImageClicked: imagesNotifier.onAddImageClicked,
                  onRemoveImageClicked: imagesNotifier.onRemoveImageClicked,
                  onProductConditionClicked: productConditionNotifier.onValueChanged,
          ...
          OrderPlacementStep.address => HookConsumer(
              builder: (context, ref, child) {
                ...
                final isSubmitEnabled = let(() {
                  ...
                  if (pickUpAddress == null || !pickUpAddress.isFilled) return false;
                  if (orderType != OrderType.giveAway) {
                    final deliveryAddress = addresses.getAtOrNull(pickUpAddressKey + 1);
                    if (deliveryAddress == null || !deliveryAddress.isFilled) return false;
                  }
                  return true;
                });
          ...
          OrderPlacementStep.price => HookConsumer(
              builder: (context, ref, child) {
                ...
                return OrderPlacementStepPriceContent(
                  ...
                  onNumOfWorkerRequestedChanged: numOfWorkersRequestedNotifier.onValueChanged,
          ...
          OrderPlacementStep.review => HookConsumer(
              builder: (context, ref, child) {
                ...
                return OrderPlacementStepReviewContent(
                  ...
                  orderSize: orderSize,
                  numOfWorkersRequested: numOfWorkersRequested,
                  productCondition: productCondition.takeIf((it) => orderType != OrderType.giveAway),
                  finalPrice: finalPrice,
                  adminFee: adminFee,
                  currency: currency,
