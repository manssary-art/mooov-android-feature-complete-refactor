...
class OrderWorkerSelectionScreenContentLoaded extends HookWidget {
  final ValueListenable<List<(UserModel, List<DateTime>)>> candidates;
  final ValueListenable<(String userId, DateTime time)?> selected;
  ...
  Widget build(BuildContext context) {
    final candidates = useValueListenable(this.candidates);
    final selected = useValueListenable(this.selected);
